{
  description = "Immich example for Self Host Blocks";
    ...
    let
      ...
      basic =
        { config, pkgs, ... }:
        {
          imports = [
            ./configuration.nix
            selfhostblocks.nixosModules.immich
      ...
      sso =
        { config, ... }:
        {
          ...
          shb.immich.sso = {
            ...
            sharedSecret.result = config.shb.sops.secret."immich/sso_secret".result;
            sharedSecretForAuthelia.result = config.shb.sops.secret."immich/authelia/sso_secret".result;
          };
          shb.sops.secret."immich/sso_secret".request = config.shb.immich.sso.sharedSecret.request;
          shb.sops.secret."immich/authelia/sso_secret" = {
            request = config.shb.immich.sso.sharedSecretForAuthelia.request;
            settings.key = "immich/sso_secret";
          };
        };
